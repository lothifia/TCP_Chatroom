...
QT_MOC_LITERAL(1, 9, 7), // "Send2UI"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 3) // "str"

    },
    "Mythread\0Send2UI\0\0str"
};
...
void Mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Send2UI((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Mythread::Send2UI)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Mythread::Send2UI(QString _t1)
{
